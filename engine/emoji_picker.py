...
class EmojiPickerUI(Gtk.Window):
    ...
    def __init__(self,
        ...
        style_provider.load_from_data(
            b'#EmojiPicker { background-color: #FFFFFF; } flowbox { background-color: #FFFFFF; } flowboxchild { border-style: solid; border-width: 1px; border-color: #F8F8F8;} row { border-style: solid; border-width: 1px; border-color: #F8F8F8; }')
